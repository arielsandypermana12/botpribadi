...
let tag = `@${m.sender.split('@')[0]}`
 ...
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
    ...
    let tks = `Saya adalah *Aespi Botz* salah satu Bot Whatsapp yang diciptakan oleh : ${ow}
Silahkan tekan Tombol ${user.registered ? '"Menu"' : '"Verify"'} untuk ${user.registered ? 'melihat list command dari' : 'mendaftar sebelum menggunakan'} AespiBotz.
...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "jpegThumbnail": await (await fetch('https://telegra.ph/file/a767c4edb85d3503b422b.jpg')).buffer(),
...
function logos() {
  ...
  if (lgs >= 4) {
    imp = 'https://i.ibb.co/YL4d3rR/Ariel-Ganteng-Banget-Wow-Omaygat-Epribadih-Teetewtwtetw-Ariel-SPnihbostengtengteng.jpg'
  }
  if (lgs > 10) {
    imp = 'https://i.ibb.co/YL4d3rR/Ariel-Ganteng-Banget-Wow-Omaygat-Epribadih-Teetewtwtetw-Ariel-SPnihbostengtengteng.jpg'
  }
