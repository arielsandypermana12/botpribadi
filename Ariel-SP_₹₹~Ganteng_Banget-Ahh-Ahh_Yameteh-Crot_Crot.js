...
conn.browserDescription =[' Ariel Sandy Permana ', 'Opera', '3.0']
let authFile = `${opts._[0] || 'Ariel-SP_GantengBanget'}.json`
...
global.reloadHandler = function () {
  ...
  conn.bye = '@user Anak Kon Keluar Dari Group Ini Kayanya Mao Mantap Mantap Sama Doi :v'
